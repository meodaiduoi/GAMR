...
os.environ['RYU_PORT'] = RYU_PORT = str(toml_dict['service-port']['ryu'])
os.environ['OFP_PORT'] = OFP_PORT = str(toml_dict['service-port']['ofp']) 
...
# Multidomain config
MULTIDOMAIN = toml_dict['app-setting']['scenario-multidomain']
