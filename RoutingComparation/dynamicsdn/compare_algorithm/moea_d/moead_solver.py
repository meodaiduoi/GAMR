...
from compare_algorithm.moea_d.function_moead import Function
from compare_algorithm.moea_d.evole_moead import Evolutionary
from compare_algorithm.moea_d.population_moead import Population
from compare_algorithm.moea_d.graph_moead import Graph

def moead_solver(task: RouteTasks):
    '''
